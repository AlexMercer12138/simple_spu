...
_Static_assert(VALUE_HAS_TYPE(6I64, long), "I64 suffix not correct");
_Static_assert(VALUE_HAS_TYPE(7UI64, unsigned long), "UI64 suffix not correct");

/** manifest:
syntax
args = --target=arm64-apple-darwin -fms-extensions --emulate=clang
*/
