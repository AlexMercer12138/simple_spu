...
msvc pointer keywords.c:8:16: error: static assertion failed due to requirement 'sizeof(void *) == 4'
msvc pointer keywords.c:8:33: note: expression evaluates to '8 == 4'
msvc pointer keywords.c:9:16: error: static assertion failed due to requirement '_Alignof(void *) == 4'
