...
// MAPPING|ONE|aarch64-generic-macos-none:Clang|aarch64-generic-fuchsia-gnu:Clang|aarch64-generic-linux-android:Clang|aarch64-generic-freebsd-gnu:Clang|aarch64-generic-hermit-eabi:Clang|aarch64-generic-linux-gnu:Gcc|aarch64-generic-linux-musl:Gcc|aarch64-generic-netbsd-gnu:Clang|aarch64-generic-other-none:Clang|aarch64-generic-openbsd-gnu:Clang|aarch64-generic-ios-none:Clang|aarch64-generic-maccatalyst-none:Clang|aarch64-generic-tvos-none:Clang|arm-baseline-other-eabi:Clang|arm-baseline-other-eabihf:Clang|arm-baseline-linux-gnueabi:Gcc|arm-baseline-linux-gnueabihf:Gcc|arm-arm710t-linux-gnueabi:Gcc|arm-arm1020e-linux-gnueabi:Gcc|arm-arm1136j_s-freebsd-gnueabihf:Clang|arm-arm1136j_s-netbsd-eabihf:Clang|arm-baseline-other-eabi:Clang|arm-baseline-other-eabihf:Clang|arm-cortex_r4-linux-android:Clang|arm-cortex_r4-other-eabi:Clang|arm-cortex_r4-other-eabihf:Clang|arm-cortex_r4-freebsd-gnueabihf:Clang|arm-cortex_r4-linux-gnueabi:Gcc|arm-cortex_r4-linux-gnueabihf:Gcc|arm-cortex_r4-netbsd-eabihf:Clang|x86-i686-windows-gnu:Gcc|mips64el-mips64-linux-gnuabi64:Gcc|mips64el-mips64-linux-musl:Gcc|mips64-mips64-linux-gnuabi64:Gcc|mips64-mips64-linux-musl:Gcc|mipsel-mips32-linux-gnu:Gcc|mipsel-mips32-linux-musl:Gcc|mipsel-mips32-other-none:Clang|mips-mips32-linux-gnu:Gcc|mips-mips32r6-linux-gnu:Gcc|mips64el-mips64r6-linux-gnuabi64:Gcc|mips64-mips64r6-linux-gnuabi64:Gcc|mips-mips32-linux-gnu:Gcc|mips-mips32-linux-musl:Gcc|powerpc64le-ppc64le-linux-gnu:Gcc|powerpc64le-ppc64le-linux-musl:Gcc|powerpc64-ppc64-freebsd-gnu:Clang|powerpc64-ppc64-linux-gnu:Gcc|powerpc64-ppc64-linux-musl:Gcc|powerpc-ppc-linux-gnu:Gcc|powerpc-ppc-linux-musl:Gcc|powerpc-ppc-netbsd-gnu:Clang|riscv32-baseline_rv32-other-eabi:Clang|riscv32-baseline_rv32-linux-gnu:Gcc|riscv64-baseline_rv64-other-eabi:Clang|riscv64-baseline_rv64-linux-gnu:Gcc|s390x-generic-linux-gnu:Gcc|sparc64-v9-linux-gnu:Gcc|sparc64-v9-netbsd-gnu:Clang|sparc64-v9-openbsd-gnu:Clang|sparc-v8-linux-gnu:Gcc|sparc64-v9-illumos-eabi:Clang|thumb-arm710t-other-eabi:Clang|thumb-cortex_m0-other-eabi:Clang|thumb-cortex_m4-other-eabihf:Clang|thumb-cortex_m4-other-eabi:Clang|thumb-cortex_m3-other-eabi:Clang|thumb-baseline-other-eabi:Clang|thumb-cortex_m33-other-eabihf:Clang|thumb-cortex_m33-other-eabi:Clang|wasm32-generic-emscripten-musl:Clang|wasm32-generic-other-musl:Clang|wasm32-generic-wasi-musl:Clang|x86_64-x86_64-maccatalyst-none:Clang|x86_64-x86_64-ios-none:Clang|x86_64-x86_64-macos-none:Clang|x86_64-x86_64-tvos-none:Clang|x86_64-x86_64-other-eabi:Clang|x86_64-x86_64-fuchsia-gnu:Clang|x86_64-x86_64-linux-android:Clang|x86_64-x86_64-illumos-eabi:Clang|x86_64-x86_64-windows-gnu:Gcc|x86_64-x86_64-dragonfly-eabi:Clang|x86_64-x86_64-freebsd-gnu:Clang|x86_64-x86_64-haiku-gnu:Clang|x86_64-x86_64-hermit-eabi:Clang|x86_64-x86_64-linux-gnux32:Gcc|x86_64-x86_64-linux-gnu:Gcc|x86_64-x86_64-linux-musl:Gcc|x86_64-x86_64-netbsd-gnu:Clang|x86_64-x86_64-openbsd-gnu:Clang|END
...
_Static_assert(sizeof(struct A028_extra_alignment) == 4, "");
_Static_assert(_Alignof(struct A028_extra_alignment) == 1, "");
_Static_assert(sizeof(struct A028_extra_packed) == 3, "");
_Static_assert(_Alignof(struct A028_extra_packed) == 1, "");
_Static_assert(sizeof(struct A028_extra_required_alignment) == 4, "");
_Static_assert(_Alignof(struct A028_extra_required_alignment) == 1, "");
_Static_assert(sizeof(struct A028_extra_size) == 5, "");
_Static_assert(_Alignof(struct A028_extra_size) == 1, "");
_Static_assert(sizeof(A029) == 4, "");
...
_Static_assert(sizeof(struct B027_extra_size) == 6, "");
_Static_assert(_Alignof(struct B027_extra_size) == 1, "");
_Static_assert(sizeof(B028) == 3, "");
_Static_assert(_Alignof(B028) == 1, "");
_Static_assert(sizeof(struct B028_extra_alignment) == 4, "");
_Static_assert(_Alignof(struct B028_extra_alignment) == 1, "");
_Static_assert(sizeof(struct B028_extra_packed) == 3, "");
_Static_assert(_Alignof(struct B028_extra_packed) == 1, "");
_Static_assert(sizeof(struct B028_extra_required_alignment) == 4, "");
_Static_assert(_Alignof(struct B028_extra_required_alignment) == 1, "");
_Static_assert(sizeof(struct B028_extra_size) == 5, "");
_Static_assert(_Alignof(struct B028_extra_size) == 1, "");
_Static_assert(sizeof(B029) == 4, "");
...
_Static_assert(sizeof(struct B108_extra_packed) == 3, "");
_Static_assert(_Alignof(struct B108_extra_packed) == 1, "");
_Static_assert(sizeof(struct B108_extra_required_alignment) == 4, "");
_Static_assert(_Alignof(struct B108_extra_required_alignment) == 1, "");
_Static_assert(sizeof(struct B108_extra_size) == 5, "");
_Static_assert(_Alignof(struct B108_extra_size) == 1, "");
_Static_assert(sizeof(B109) == 4, "");
