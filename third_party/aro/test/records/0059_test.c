...
#ifndef SKIP_OFFSETS
#endif
// MAPPING|TWO|aarch64-generic-windows-msvc:Clang|x86-i586-windows-msvc:Clang|x86-i686-windows-gnu:Gcc|x86-i686-windows-msvc:Clang|x86-i686-uefi-msvc:Clang|thumb-baseline-windows-msvc:Clang|x86_64-x86_64-windows-gnu:Gcc|x86_64-x86_64-windows-msvc:Clang|x86_64-x86_64-uefi-msvc:Clang|END
