...
export interface IRFunction { readonly name: string; readonly returnType?: CType; readonly parameters: readonly CType[]; readonly parameterNames?: readonly string[]; readonly localNames?: readonly string[]; readonly blocks: readonly IRBlock[]; }
