...
export interface Declarator { readonly name?: string; readonly type: CType; readonly parameters?: readonly ParameterDeclaration[]; readonly body?: CompoundStatement; readonly initializer?: Initializer; readonly location?: SourceLocation; }
