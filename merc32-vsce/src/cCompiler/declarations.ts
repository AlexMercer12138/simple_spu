...
export interface Declarator { readonly name?: string; readonly type: CType; readonly parameters?: readonly ParameterDeclaration[]; readonly body?: CompoundStatement; readonly initializer?: Expression | Initializer; readonly location?: SourceLocation; }
